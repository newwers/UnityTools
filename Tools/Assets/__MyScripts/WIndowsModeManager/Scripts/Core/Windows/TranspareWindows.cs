...
public class TranspareWindows : MonoBehaviour
{
    ...
    public bool isSetTranspareWindows = false;

    IEnumerator DelaySetTranspareWindows()
    {
        yield return null;
#if !UNITY_EDITOR
        SetWindowTop(true);
    ...
    public void ExitTranspareWindows()
    {
        isSetTranspareWindows = false;
    }
    ...
    {
        if (!isSetTranspareWindows) return;
#if UNITY_EDITOR
        return;
#endif
