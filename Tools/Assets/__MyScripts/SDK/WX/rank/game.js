...
const managerConfig = {
    DATA_FILE_MD5: '9eb66bf881e711ae',
    CODE_FILE_MD5: '3b3b142296b626c9',
    GAME_NAME: 'webgl',
    APPID: 'wx31ea30b346ccda0b',
    DATA_FILE_SIZE: '25340209',
    OPT_DATA_FILE_SIZE: '$OPT_DATA_FILE_SIZE',
    DATA_CDN: 'https://706b-pk-3glrvvjra6adb00d-1333230460.tcb.qcloud.la/105',
    // 资源包是否作为小游戏分包加载
...
wx.cloud.init({env:'pk-3glrvvjra6adb00d'})